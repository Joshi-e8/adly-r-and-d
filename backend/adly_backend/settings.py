...
META_REDIRECT_BASE_URL = config('META_REDIRECT_BASE_URL', default='http://localhost:8000/api/v1/ad-accounts/oauth/meta/callback/')
LINKEDIN_CLIENT_ID = config('LINKEDIN_CLIENT_ID', default='')
LINKEDIN_CLIENT_SECRET = config('LINKEDIN_CLIENT_SECRET', default='')
LINKEDIN_REDIRECT_BASE_URL = config('LINKEDIN_REDIRECT_BASE_URL', default='http://localhost:8000/api/v1/ad-accounts/oauth/linkedin/callback/')
LINKEDIN_SCOPES = config('LINKEDIN_SCOPES', default='r_liteprofile')

# YouTube (Google OAuth)
YOUTUBE_CLIENT_ID = config('YOUTUBE_CLIENT_ID', default='')
YOUTUBE_CLIENT_SECRET = config('YOUTUBE_CLIENT_SECRET', default='')
YOUTUBE_REDIRECT_BASE_URL = config('YOUTUBE_REDIRECT_BASE_URL', default='http://localhost:8000/api/v1/ad-accounts/oauth/youtube/callback/')
YOUTUBE_SCOPES = config('YOUTUBE_SCOPES', default='https://www.googleapis.com/auth/youtube.readonly')
